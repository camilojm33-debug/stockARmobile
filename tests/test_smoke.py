...
def test_core_routes_and_decimal_checkout():
    ...
    assert client.get("/superadmin/logs").status_code == 200
    assert client.get("/superadmin/logs?days=7&q=company").status_code == 200
    assert client.get("/superadmin/users").status_code == 200
...
def test_offline_first_shell_and_critical_forms_are_wired():
    ...
    assert "stockarmobile-pwa-v11" in worker_js
