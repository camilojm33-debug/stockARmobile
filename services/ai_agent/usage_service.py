...
AI_PLANS = (
    ...
    {"code": "vendedor", "name": "Vendedor", "price": "$27.885 / mes", "limit": 1500, "agents": ("asistente", "vendedor"), "tagline": "Tu vendedor trabaja 24/7", "badge": None, "invoice_processing": False},
