...
AI_PLANS = (
    ...
    {"code": "vendedor", "name": "Vendedor", "price": "$47.890 / mes", "limit": 1500, "agents": ("asistente", "vendedor"), "tagline": "Asistente + Vendedor IA 24/7: atiende consultas, recomienda productos y prepara presupuestos y pedidos.", "badge": None, "invoice_processing": False},
    {"code": "negocio", "name": "Negocio IA", "price": "$67.890 / mes", "limit": 5000, "agents": ("asistente", "vendedor", "analista"), "tagline": "Sumá Analista IA: compara ventas, detecta baja rotación y clientes inactivos y encuentra oportunidades.", "badge": "RECOMENDADO", "invoice_processing": False, "pricing_controller": True},
