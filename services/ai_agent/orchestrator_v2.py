...
class VendorAddTool(AgentTool):
    name="agregar_al_carrito"; description="Agrega un producto por nombre, código o consulta y cantidad al carrito."; input_schema={"type":"object","properties":{"product_query":{"type":"string"},"quantity":{"type":"number","minimum":0.01}},"required":["product_query","quantity"],"additionalProperties":False}
...
class VendorRemoveTool(AgentTool):
    name="quitar_del_carrito"; description="Quita del carrito un producto por nombre o código."; input_schema={"type":"object","properties":{"product_query":{"type":"string"}},"required":["product_query"],"additionalProperties":False}
...
class VendorOrderPreviewTool(AgentTool):
    name="preparar_pedido"; description="Prepara un pedido pendiente y genera un link seguro de pago Mercado Pago; no confirma el cobro."; input_schema={"type":"object","properties":{"customer_name":{"type":"string"}},"additionalProperties":False}
...
class AgentRuntime:
    ...
    def process(cls,*,company_id,conversation_id,message,channel,sender_id=None,external_message_id=None,idempotency_key=None,metadata=None,provider_override=None,include_system_prompt=True):
        ...
        history=cls._history(company_id,conversation.id,20)
