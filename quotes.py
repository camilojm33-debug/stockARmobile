    ...
    sales_blueprint._set_quote_cart_prefill(
        {
            ...
            "tax_amount": float(quote.tax or 0),
            "quote_total": float(quote.total_amount or 0),
            "quote_subtotal": float(quote.subtotal or 0),
            "quote_discount": float(quote.discount or 0),
            "quote_surcharge": float(quote.surcharge or 0),
            "quote_charges": _quote_charge_snapshot(quote),
