...
def test_build_ticket_contains_sale_and_total():
    ...
    assert "machimbre: $5.600,00".encode("cp1252") in payload
    assert "2 x $5.300,00 = $10.600,00".encode("cp1252") in payload
    assert "TOTAL: $16.200,00".encode("cp1252") in payload
